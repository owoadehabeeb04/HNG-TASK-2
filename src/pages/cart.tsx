      ...
      <div>
        ...
        {cartProducts && cartProducts.length > 0 ? (
          ...
          <div className="flex justify-center gap-[0.6rem] sm:gap-4   items-center flex-col my-6 sm:h-fit h-[60vh]  ">
            ...
            <Link to="/Shop">
              <button className=" rounded-[6px] mx-auto sm:w-fit w-full bg-black text-white flex justify-center items-center py-4 px-10 font-OpenSans font-medium leading-normal max-[1024px]:py-4 max-[1024px]:px-4  max-[480px]:mt-[0rem]">
                <span> Shop Now </span>
              </button>
            </Link>
          </div>
